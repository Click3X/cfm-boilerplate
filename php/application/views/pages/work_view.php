...
<div class="project-container">
	<ul class="project-list">
		<li id="p1" class="project">
			<div class="project-inner">
				<a href="<?= base_url(); ?>project/p1" data-navigate-to="project/p1">
					<div class="project-label"><div class="project-label-inner">Project Title One</div></div>
				</a>
			</div>
		</li>
		<li id="p2" class="project">
			<div class="project-inner">
				<a href="<?= base_url(); ?>project/p2" data-navigate-to="project/p2">
					<div class="project-label"><div class="project-label-inner">Project Title Two</div></div>
				</a>
			</div>
		</li>
		<li id="p3" class="project">
			<div class="project-inner">
				<a href="<?= base_url(); ?>project/p3" data-navigate-to="project/p3">
					<div class="project-label"><div class="project-label-inner">Project Title Three</div></div>
				</a>
			</div>
		</li>
		<li id="p4" class="project">
			<div class="project-inner">
				<a href="<?= base_url(); ?>project/p4" data-navigate-to="project/p4">
					<div class="project-label"><div class="project-label-inner">Project Title Four</div></div>
				</a>
			</div>
		</li>
		<li id="p5" class="project">
			<div class="project-inner">
				<a href="<?= base_url(); ?>project/p5" data-navigate-to="project/p5" >
					<div class="project-label"><div class="project-label-inner">Project Title Five</div></div>
				</a>
			</div>
		</li>
		<li id="p6" class="project">
			<div class="project-inner">
				<a href="<?= base_url(); ?>project/p6" data-navigate-to="project/p6" >
					<div class="project-label"><div class="project-label-inner">Project Title Six</div></div>
				</a>
			</div>
		</li>
	</ul>
